    ...
    <div className="w-full lg:w-[768px] lg:h-[353px] flex flex-col justify-center items-center">
     ...
     {/* capabilites */}
      <div className="lg:w-full lg:h-[1076.68px] w-[375px] h-[1538px] bg-[#07050D] flex justify-center items-center">
        <div className="w-[335px] h-[1410px] lg:w-[1280px] lg:h-[852.68px] border border-white flex-col flex justify-center">
          <div className="lg:w-[768px] lg:h-[160px] w-[335px] h-[167px] lg:ms-[256px] flex-col justify-center border border-white">
          ...
          <div className="w-[335px] h-[1065px] lg:w-[1280px] lg:h-[443.68px] border border-white lg:flex justify-center lg:mt-[80px] mt-[48px]">
            {/* Card 1 */}
            <div className="lg:w-[394.67px] lg:h-[443.68px] w-[335px] h-[323px]">
          <div className="w-[335px] h-[198px] lg:w-[394.67px] lg:h-[233.68px] rounded-2xl overflow-hidden">
           <img src={card02} alt="" className="w-full h-full object-cover"/></div>
                <div className="lg:w-[394.67px] lg:h-[178px] w-[335px] h-[101px] mt-[24px] lg:mt-[32px]">
                  ...
                  <div className="w-[335px] h-[101px] mt-[20px] lg:w-[394.67px] lg:h-[58px] lg:mt-[24px] ">
                    <p className='text-center lg:text-lg text-sm text-white'>Custom applications engineered for scale, security, and performance.</p>
                  </div>
                </div>
            </div>
            {/* card 2 */}
            <div className="lg:w-[394.67px] lg:h-[395.68px] w-[335px] h-[323px] lg:ms-[48px] lg:mt-0  mt-[48px]">
              <div className="lg:w-[394.67px] lg:h-[233.68px] w-[335px] h-[198px]"><img src={card01} className='w-full h-full object-cover'  alt="" /></div>
              <div className="lg:w-[394.67px] lg:h-[130px] w-[335px] h-[101px] lg:mt-[32px] mt-[24px]">
                ...
                <div className="w-[335px] h-[52px] lg:w-[394.67px] lg:h-[58px] lg:mt-[24px] mt-[20px]">
                  <p className='text-center lg:text-lg text-sm text-white'>Strategic campaigns that reach the right audience and drive measurable growth.</p>
                </div>
              </div>
            </div>
            {/* card 3 */}
            <div className="lg:w-[394.67px] lg:h-[395.68px] w-[335px] h-[323px] border lg:ms-[48px] lg:mt-0  mt-[48px] border-white"></div>
          </div>
        </div>
      </div>
